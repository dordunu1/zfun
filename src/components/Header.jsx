...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 right-0 left-64 h-16 bg-white dark:bg-[#0d0e12] border-b border-gray-200 dark:border-gray-800 px-6 flex items-center justify-end gap-4 z-10">
      <button
